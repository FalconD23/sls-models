...
ROOT_DIR = "/home/ubnps23/tecHub/SLS_dev/CAD_testing/cad_analysis/planes_cmp/tetrahedrons_sls"

# STL_FILENAME = "/home/ubnps23/tecHub/SLS_dev/CAD_testing/cad_analysis/planes_cmp/stlgen/csbs_0.stl"
STL_FILENAME = f"{ROOT_DIR}/tetrah_sls.stl"  # from legacy
FACES_NUM = 4
GUI = True
TOLERANCE = 0.1
...
CC_FILENAME = f'{ROOT_DIR}/cc_pairs.csv'
CENTERS_DIST_FOR_CONTACT = 0.5 * 1e2 # mm, NEED TO MAKE CC_PAIRS USING NEAREST NEIGHBORS
FRICTION_COEFF = 0.3
SLOPE_COEFF = 1e0

doc_prefix = "Steel_tetrahedrons_"
pressures_N_force = [i*1e7*1e0 / (10) for i in range(1, 11)]  # потому что прилагаются 3 силы к 3 вершинам
results = []
