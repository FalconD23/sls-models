...
from angle_stlgen import generate_stl_for_angle
...
pressures_N_force = [i*1e7*1e0 / (10) for i in range(5,6)]
angles = list(range(10, 50, 2))
results = []
...
for angle in angles:
    ...
    stl_file_path = generate_stl_for_angle(
        ...
        filename_prefix="bev_hex_prisms"
    )
